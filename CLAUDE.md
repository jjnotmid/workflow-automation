...
- When a documentation file (README, ARCHITECTURE, etc.) does get created or rewritten, write it in Joshua's own voice as though he drafted it himself — first person where a person would naturally speak, no "generated by Claude" framing, no assistant-style meta-commentary about the writing process itself.
